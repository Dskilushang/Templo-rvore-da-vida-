...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function showPage(page) {
    ...
    switch(page) {
      ...
      case 'departements': html = renderDepartements(); break;
      case 'membres': html = renderMembres(); break;
      case 'rapports': html = renderRapports(); break;
      case 'annonces': html = renderAnnonces(); break;
  ...
  function renderDashboard() {
    ...
    const actus = data.activites;
    const rapp = data.rapports;
    ...
    return `
      ...
      ${rapp.map(r => `<div class="list-item"><span>${r}</span></div>`).join('')}
    `;
  }
